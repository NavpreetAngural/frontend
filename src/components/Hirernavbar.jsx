...
const Hirernavbar = () => {
    ...
    const handleLogout = () => {
        ...
        // setFullname(null); // Remove fullname from state
        navigation("/"); // Navigate to the homepage
    };

    const handleProfileClick = () => {
        setIsProfileClicked(true); // Set the profile view to true
        navigation("/hirerdashboard/hirerprofile"); // Redirect to the user profile page
    };
        ...
        <header id="head">
            <nav className="navbar flex justify-between items-center shadow-md bg-white">
                ...
                <ul className={`fixed md:static top-16 left-0 w-full md:w-auto bg-white md:bg-transparent shadow-md md:shadow-none flex flex-col md:flex-row gap-4 md:gap-6 items-center 
                    ...
                    <li className="py-2 md:py-0 text-lg"><NavLink to="/hirerdashboard" className="hover:text-blue-500">Home</NavLink></li>
                    <li className="py-2 md:py-0 text-lg"><NavLink to="/hirerdashboard/addvehicle" className="hover:text-blue-500">Add Vehicle</NavLink></li>
                    <li className="py-2 md:py-0 text-lg"><NavLink to="/hirerdashboard/managevehicle" className="hover:text-blue-500">Manage Vehicle</NavLink></li>
                    <li className="py-2 md:py-0 text-lg"><NavLink to="/hirerdashboard/viewbooking" className="hover:text-blue-500">View Bookings</NavLink></li>
                    ...
                    <div className="relative group inline-block p-4 rounded-lg cursor-pointer hover:bg-gray-100 transition duration-300 ease-in-out">
                        <li className="py-2 md:py-0 text-lg">
                            <p className="text-lg font-semibold text-gray-800 hover:text-blue-600 transition-all border-2 border-gray-300 hover:border-blue-500 rounded-lg !px-4 !py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white shadow-lg transform transition-all duration-300 group-hover:scale-105">
                                {fullname}
                            </p>
                        </li>
                            ...
                            {isProfileClicked ? (
                                ...
                                <li className="hover:bg-gray-50 transition duration-200">
                                    <button
                                        ...
                                        className="w-full px-6 py-3 text-sm text-gray-700 font-medium rounded-t-lg hover:bg-blue-50"
                                    >
                                        View Profile
                                    </button>
                                </li>

        ...
        <footer className="bg-gray-800 text-white !py-10 !px-5 !mt-10">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between !gap-11">
                ...
                <div className="flex-1 text-center">
                    ...
                    <ul className="flex flex-col items-center !gap-y-3">
                        <li><NavLink to="/hirerdashboard/addvehicle" className="hover:underline">Add Vehicle</NavLink></li>
                        <li><NavLink to="/hirerdashboard/managevehicle" className="hover:underline">Manage Vehicle</NavLink></li>
                        <li><NavLink to="/hirerdashboard/viewbookings" className="hover:underline">View Bookings</NavLink></li>
                    </ul>
                </div>
